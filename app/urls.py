...
urlpatterns = [
    ...
    path('gridsearch/<str:model>', views.gridsearch, name='gridsearch'),
    path('forecast/<str:model>', views.forecast, name='forecast'),
    path('previsao/<str:model>', views.previsao, name='previsao'),
    path('multic/<str:model>', views.multic, name='multic'),
    path('multir/<str:model>', views.multir, name='multir'),
